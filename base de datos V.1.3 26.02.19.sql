...
CREATE TABLE IF NOT EXISTS `parking_sky`.`registro_vehiculo` (
  `id_Registro_Vehiculo` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  `id_Registro_Visitantes` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `parking_sky`.`ingreso_vehiculo` (
  `id_Ingreso_Vehiculo` INT(11) NOT NULL AUTO_INCREMENT,
  `Fecha_Hora_Ingreso` SMALLINT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `parking_sky`.`salida_vehiculo` (
  `id_Salida_Vehiculo` INT(11) NOT NULL AUTO_INCREMENT,
  `Forma_Pago` VARCHAR(45) NOT NULL,
  `Fecha_Hora_Ingreso` SMALLINT(11) NOT NULL,
  `id_Ingreso_Vehiculo` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `parking_sky`.`validar_ubicacion_vehiculo` (
  `id_Validar_Ubicacion_Vehiculo` INT(11) NOT NULL,
  `Bahia_Numero` INT(11) NOT NULL,
